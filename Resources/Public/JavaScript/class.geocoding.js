...
function Geocoding() {
    ...
    this.displayPreview = function(uid, defaultZoom, defaultMapType, defaultMapControl, mapProvider, mapboxAccesstoken) {
        ...
        // TYPO3 >= 10.x
            ...
            && jQuery("input[data-formengine-input-name*=\'" + fieldPrefix1 + "[settings.cbgmStreet][vDEF]\']")) {

            infoText = jQuery("textarea[name*=\'" + fieldPrefix2 + "[settings.cbgmDescription][vDEF]\']").val();
            mapZoom = parseInt(jQuery("input[data-formengine-input-name*=\'" + fieldPrefix2 + "[settings.cbgmScaleLevel][vDEF]\']").val(), 10);
            mapType = jQuery("select[name*=\'" + fieldPrefix2 + "[settings.cbgmMapType][vDEF]\']").val();
            mapControl = jQuery("select[name*=\'" + fieldPrefix2 + "[settings.cbgmNavigationControl][vDEF]\']").val();
        }
    ...
    this.getAddressFromBackend = function (gmap){
        ...
        // TYPO3 >= 10.x
            ...
            && jQuery("input[data-formengine-input-name*=\'" + fieldPrefix + "[settings.cbgmStreet][vDEF]\']")) {
            // set address to gmap instance, street, zip, city and country
            gmap.setAddress(
                jQuery("input[data-formengine-input-name*=\'" + fieldPrefix + "[settings.cbgmStreet][vDEF]\']").val(),
                jQuery("input[data-formengine-input-name*=\'" + fieldPrefix + "[settings.cbgmZip][vDEF]\']").val(),
                jQuery("input[data-formengine-input-name*=\'" + fieldPrefix + "[settings.cbgmCity][vDEF]\']").val(),
                jQuery("input[data-formengine-input-name*=\'" + fieldPrefix + "[settings.cbgmCountry][vDEF]\']").val()
            );
        }
    };
    ...
    this.getCoordinatesFromBackend = function(gmap){
        ...
        // TYPO3 >= 10.x
            ...
            gmap.setLatitude( parseFloat(
                jQuery("input[data-formengine-input-name*=\'" + fieldPrefix + "[settings.cbgmLatitude][vDEF]\']").val()
            ));
            gmap.setLongitude( parseFloat(
                jQuery("input[data-formengine-input-name*=\'" + fieldPrefix + "[settings.cbgmLongitude][vDEF]\']").val()
            ));
        }
    };
